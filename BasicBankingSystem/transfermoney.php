...
<div class="container">
        <h1 class="glow1">Transfer Money</h1>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn1 m-2">Show Details/Transfer</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
